...
const charterTemplate = app.vault.getFileByPath('Templates/Project/10 Project Charter Template.md');
const taskTemplate = app.vault.getFileByPath('Templates/Project/10 Tasks Template.md');
const mentionsTemplate = app.vault.getFileByPath('Templates/Project/10 Mentions Template.md');
