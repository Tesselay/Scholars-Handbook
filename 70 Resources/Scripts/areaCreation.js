...
const charterTemplate = app.vault.getFileByPath('70 Resources/Templates/Area/20 Area Charter Template.md');
const taskTemplate = app.vault.getFileByPath('70 Resources/Templates/Area/20 Tasks Template.md');
const mentionsTemplate = app.vault.getFileByPath('70 Resources/Templates/Area/20 Mentions Template.md');
